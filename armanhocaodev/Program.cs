    ...
    class Yonetic
    {
        ...
        public void AracSat(string model)
        {
            ...
            if (arac != null)
            {
                ...
                int indirimSecim;
                while (!int.TryParse(Console.ReadLine(), out indirimSecim) || indirimSecim < 1 || indirimSecim > 3)
                {
                    Console.Write("Geçerli bir indirim seçin (1-3): ");
                }
        ...
        public void AracKirala(string model)
        {
            ...
            if (arac != null)
            {
                ...
                {
                    Console.Write("Geçerli bir kiralama süresi girin: ");
                }
